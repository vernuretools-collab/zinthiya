...
export default function VolunteerRegister() {
  ...
  const [formData, setFormData] = useState({
    ...
    support_categories: [],
    languages: [],
    contact_preference: '', // 'phone' | 'personal' | 'both'
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.contact_preference) {
      alert('Please choose how you are available (phone, in-person, or both)');
      return;
    }
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      type="button"
                      onClick={() => handleChange('contact_preference', 'phone')}
                      className={`
                        px-3 py-2 sm:px-4 sm:py-2.5 rounded-full border-2 transition-all duration-200
                        text-xs sm:text-sm md:text-base font-medium
                    ...
                    <button
                      type="button"
                      onClick={() => handleChange('contact_preference', 'personal')}
                      className={`
                        px-3 py-2 sm:px-4 sm:py-2.5 rounded-full border-2 transition-all duration-200
                        text-xs sm:text-sm md:text-base font-medium
                        ${formData.contact_preference === 'personal'
                          ? 'border-blue-600 bg-blue-50 text-blue-700 ring-2 ring-blue-300'
                          : 'border-gray-200 hover:border-blue-300 hover:bg-blue-50/50 text-gray-700'
                        }
                      `}
                    ...
                    <button
                      type="button"
                      onClick={() => handleChange('contact_preference', 'both')}
                      className={`
                        px-3 py-2 sm:px-4 sm:py-2.5 rounded-full border-2 transition-all duration-200
                        text-xs sm:text-sm md:text-base font-medium
