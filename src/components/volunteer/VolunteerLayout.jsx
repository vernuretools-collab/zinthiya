...
export default function VolunteerLayout({ children }) {
  ...
  // 🔥 Fetch volunteer profile data on mount
  useEffect(() => {
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-600">Adviser Portal</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
              ...
              {/* 🔥 UPDATED AVATAR WITH UPLOADED IMAGE */}
              <Avatar 
                className="h-7 w-7 sm:h-8 sm:w-8 md:h-9 md:w-9 cursor-pointer hover:ring-2 hover:ring-blue-200 transition-all" 
                onClick={() => navigate('/volunteer/profile')}
              >
                {volunteer?.profile_image_url ? (
                  <AvatarImage 
                    src={volunteer.profile_image_url} 
                    alt={volunteer.full_name || 'Profile'}
                    className="object-cover"
                  />
                ) : (
                  <AvatarFallback className="text-xs sm:text-sm bg-gradient-to-br from-blue-500 to-indigo-600">
