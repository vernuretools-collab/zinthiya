...
import VolunteerCancel from './pages/volunteer/VolunteerCancel';
import VolunteerReschedule from './pages/volunteer/VolunteerReschedule';
import UserBookings from './pages/public/UserBookings';
import VictimReschedule from './pages/public/VictimReschedule';
import BookingRatingPage from './pages/public/BookingRatingPage';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/booking/:id/reschedule" element={<VictimReschedule />} />
        <Route path="/booking/:bookingId/rate" element={<BookingRatingPage />} />
        ...
        />
        <Route path="/volunteer/bookings/:id/cancel" element={
          <ProtectedRoute>
            <VolunteerCancel />
          </ProtectedRoute>
        } />
        <Route path="/volunteer/bookings/:id/reschedule" element={
          <ProtectedRoute>
            <VolunteerReschedule />
          </ProtectedRoute>
        } />
